...
const QUICK_NAV_COMMANDS: Array<{ panel: string; titleKey: string; title: string; aliases: string[] }> = [
  ...
  { panel: 'projects', titleKey: 'goToProjects', title: 'Go to Projects', aliases: ['project manager', 'project env', 'project environment'] },
  ...
  { panel: 'integrations', titleKey: 'goToIntegrations', title: 'Go to Integrations & Env', aliases: ['providers', 'api keys', 'env', 'environment variables', 'secrets'] },
